...
<nav class="navbar header-navbar pcoded-header">
	<div class="navbar-wrapper">
		<div class="navbar-logo">
			<a class="mobile-menu waves-effect waves-light" style="right: 200px" id="mobile-collapse"
			...
			<ul class="nav-right">
				<li class="header-notification"><a href="#!"
					...
					<ul class="show-notification">
						<li>
							<h6>Notificação</h6> <label class="label label-danger">Novas</label>
						</li>
						<li class="waves-effect waves-light">
							<div class="media">
								...
								<div class="media-body">
									<h5 class="notification-user">Sophia Smith</h5>
									<p class="notification-msg">Lorem ipsum dolor sit amet,
										consectetuer elit.</p>
									<span class="notification-time">30 minutes atrás</span>
								</div>
							</div>
						</li>
						<li class="waves-effect waves-light">
				...
				<li class="user-profile header-notification"><a href="#!"
					...
					<ul class="show-notification profile-notification">
						...
						<li class="waves-effect waves-light"><a
							href="<%= request.getContextPath() %>/ServletsLogin?acao=logout"> <i
